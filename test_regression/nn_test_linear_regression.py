...
neural_net_delivery_2 = nnp.NeuralNetwork([m_del - 1, 2])
Y_delivery_one_hot = np.identity(2, dtype=int)[Y_delivery]
error_history, accuracy_history, gradients, softmax = neural_net_delivery_2.train(x=X_delivery, y=Y_delivery_one_hot,
